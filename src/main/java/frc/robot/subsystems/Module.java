...
public class Module {
    ...
    private static final double THRIFTY_VOLTAGE_TO_RADIANS = 2 * Math.PI / 5.0;
    private static final double THRIFTY_FILTER_ALPHA = 0.2;
    ...
    public Module(String moduleName, int drivingCANId, int turningCANId, int analogPort, double chassisAngularOffset) {
        ...
        // Modified turning configuration for external analog encoder
    ...
    private double getRawEncoderRadians() {
        ...
        double position = voltage * THRIFTY_VOLTAGE_TO_RADIANS;
    ...
    private double getAbsoluteEncoderRadians() {
        ...
        position = m_lastPosition + THRIFTY_FILTER_ALPHA * (position - m_lastPosition);
